...
const drawTree = (graph, face) => {
  ...
  tree.forEach(row => row.forEach(el => {
    ...
    layer.line(faces_center[el.face], faces_center[el.parent])
      .strokeWidth(0.01)
      .strokeDasharray("0.00001 0.015")
      .strokeLinecap("round")
      .stroke("#e53");
  }));
  layer.circle(center).radius(0.02).fill("#e53").stroke("none");
};
